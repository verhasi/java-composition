...
public final class JavaParserMetaModel {
    ...
    private static void initializeNodeMetaModels() {
        ...
        nodeMetaModels.add(unparsedBlockStatementMetaModel);
    ...
    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    public static final UnparsedBlockStatementMetaModel unparsedBlockStatementMetaModel = new UnparsedBlockStatementMetaModel(Optional.of(blockStmtMetaModel));
